...
double MersenneRandom(void);                                    // Output random float
uint32_t MersenneBRandom(void);                                 // Output random bits
...
double DLL_STDCALL MersenneRandomD(void);                       // Output random float
uint32_t DLL_STDCALL MersenneBRandomD(void);                    // Output random bits
...
double MotherRandom(void);                                      // Output random float
uint32_t MotherBRandom(void);                                   // Output random bits
...
double DLL_STDCALL MotherRandomD(void);                         // Output random float
uint32_t DLL_STDCALL MotherBRandomD(void);                      // Output random bits
...
double SFMTgenRandom(void);                                    // Output random floating point number, double presision
long double SFMTgenRandomL(void);                              // Output random floating point number, long double presision
uint32_t SFMTgenBRandom(void);                                 // Output random bits
...
double DLL_STDCALL SFMTgenRandomD(void);                       // Output random float
uint32_t DLL_STDCALL SFMTgenBRandomD(void);                    // Output random bits
